...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Static/dynamic file/firmware/code analysis
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Scoren rope skipping met computer vision en machine learning
...
\begin{frame}[plain]
  ...
  \begin{itemize}
    ...
    \end{itemize}
    \item Hoe ga je het systeem operationeel inzetten?
    \begin{itemize}
      \item Data workflow?
      \item Wat doe je met het resultaat?
      \item Hoe ga je bijtrainen, testen, evalueren?
    \end{itemize}
  \end{itemize}
\end{frame}

\begin{frame}
  \frametitle{Iteratief proces}

  \begin{itemize}
  \item Selecteer vooraf (minstens) één \textit{research paper}

    \begin{itemize}
      \item Reproduceer methodologie beschreven in paper
      \item Pas aan waar nodig voor jouw casus
      \item Niet gelukt? Probeer in volgende iteratie:
      \begin{itemize}
        \item Pas parameters/configuratie/methode aan
        \item Probeer met een andere \textit{research paper}
      \end{itemize} 
    \end{itemize}
...
\begin{frame}
  ...
  \alertbox{Begin zo snel mogelijk met bouwen van je testopstelling! Dit is belangrijer dan het schrijven van een literatuuroverzicht.}
\end{frame}
...
\begin{frame}
  ...
  \alertbox{Er zijn nog meer statistische technieken dan we in Data Science gezien hebben!}
\end{frame}
...
\begin{frame}
  ...
  \begin{itemize}
    \item Formaat zo eenvoudig mogelijk: tekstgebaseerd
    
    \begin{itemize}
      \item CSV: rijen = observaties, kolommen = variabelen
      \item JSON, YAML, XML: zijn ook machine readable
    \end{itemize}

    \item Ruwe data (CSV) NOOIT wijzigen
    
    \begin{itemize}
      \item Manuele wijzigingen zijn foutgevoelig
      \item Niet transparant/reproduceerbaar
      \item Niet te onderscheiden van manipulatie
      \item \href{https://www.bbc.com/news/technology-37176926}{Kan resultaten ongeldig maken}!
    \end{itemize}
...
\begin{frame}
  ...
  (Zie ook de cursus Data Science)
...
\begin{frame}
  \frametitle{Opgelegde deadlines BP 25--26}

  \begin{description}
    \item[2025--11--12] eerste voorstel indienen
    \item[2026--01--23] finaal voorstel indienen
    \item[2026--05--04] draft inleiding, literatuurstudie en methodologie
    \item[2026--05--02] draft BP indienen
    \item[2026--05--29] finale BP indienen
  \end{description}
  \medskip
  Telkens met mondelinge toelichting door de student een feedback van de promotor.
  \medskip

  \textbf{Pas dit zelf toe op AJ 26--27.}
...
\begin{frame}
  ...
  \begin{itemize}
    \item Volgorde hoofdstukken BP $\neq$ volgorde uitwerking!
