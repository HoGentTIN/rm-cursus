...
\begin{frame}{Geschikte onderwerpen}
  ...
  \alertbox{Start vanuit een concrete, \textcolor{hgyellow}{reële bedrijfscasus} of probleemsituatie!}
...
\begin{frame}{Zelf een onderwerp zoeken}
  ...
  \begin{itemize}
    ...
    \item Relevante conferenties/meetups (bv. Devoxx, FOSDEM, Config Management Camp, \ldots)
    \item Lokale vakverenigingen (bv. OWASP Belgium)
    \item Belangrijkste namen in ``community'' volgen via blog/sociale media
	\item Zoek via trefwoorden in databanken naar (heel) recente publicaties binnen je specialisatie/interessegebied
    \item Nieuwsbrieven en vaktijdschriften (bijv. \url{https://www.sai.be})
    \begin{itemize}
    	\item Bib op campus Schoonmeersen heeft fysieke tijdschriften beschikbaar.
    \end{itemize}
    \item \ldots
  \end{itemize}
