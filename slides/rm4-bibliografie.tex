...
\alertbox{Gebruik \textcolor{hgyellow}{referentiesoftware} om je referentielijst op te maken!}
...
\begin{frame}
  \frametitle{Algemene bibliografische gegevens.}
...
\begin{frame}[fragile,plain]
  \frametitle{Specifieke info voor Article}
...
\begin{frame}[plain]
  \frametitle{Specifieke info voor Electronic}
...
\begin{frame}[plain]
  \frametitle{Specifieke info voor InProceedings}
...
\begin{frame}[plain]
  \frametitle{Specifieke info voor Book}
...
\begin{frame}
  \frametitle{Specifieke info voor Report/Thesis}
...
\begin{frame}
  \frametitle{Andere bibliografische gegevens in JabRef.}
...
\begin{frame}[plain]
  ...
  \begin{itemize}
    ...
    \item \url{https://hogent.on.worldcat.org/oclc/1520118695}
...
\begin{frame}
  ...
  \begin{itemize}
    \item Gebruik deze info + bezoek bib om geschikte bronnen te vinden voor jullie geselecteerde onderwerpen
    \item Sla op in JabRef, met alle nodige info, zet op Github-repo
    \item Hou fulltext bij (maar niet in GH!)
    \item Test of je kan refereren vanuit je .tex-bestand en of de literatuurlijst correct wordt weergegeven
  \end{itemize}
