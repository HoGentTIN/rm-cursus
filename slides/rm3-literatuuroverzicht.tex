...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Onbestaande bronnen (LLM hallucinaties)
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \end{itemize}
    \item<+-> Kun je de VPN client niet installeren? Log in op Chamilo en klik op de tegel \textbf{BIB Bronnen} (via Academic Software)
    \begin{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item<+-> \textbf{SpringerLink}
      \begin{itemize}
        \item e-boeken over IT (incl. Apress)
...
\begin{frame}
  ...
  \begin{itemize}
    ...
    \item Door LLM gehallucineerde bron
  \end{itemize}
\bigskip
