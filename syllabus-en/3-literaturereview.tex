...
This chapter takes a closer look at this topic: what exactly can you achieve with a literature review, how can you start working on it, and how to use the sources that you found in your text?
...
Based on the literature review, you provide the reader with the necessary background to understand the subject. It is an introduction to the subject, and discusses the current state of the art. You state what the experts in the field have to say about it and what research has already been carried out in the past (with the main conclusions). The literature review should also show that there are still gaps in our knowledge, that there is a problem that requires a solution. And that is of course exactly the subject of your bachelor's thesis.
...
A tool when assessing the quality of a resource is the \emph{CRAAP-test} \autocite{Blakeslee2004}:
...
\begin{description}
   \item[Currency] or topicality: is the source sufficiently recent for the topic?
      ...
      \item[Accuracy] Is the information correct? Does it contain references to other work? 
      Can the information be verified or is it peer reviewed? Is the language professional?
   \item[Purpose] or objectivity: what is the intention of the author? What does he/she want to achieve?
\end{description}
...
\begin{itemize}
   \item The aim of the literature review is to provide yourself and the reader of your bachelor's thesis with sufficient context to fully understand the subject.
