...
The results (including discussion and conclusion) often form the most interesting part of a bachelor’s thesis. Since these results frequently include numerical data, it is crucial for a clear discussion of your findings that you can add correct visualizations to your thesis. However, we still see many mistakes being made in bachelor’s theses when processing and presenting numerical data, which can lead to incorrect conclusions. Therefore, be sure to review the Data Science \& AI course material \footnote{\url{https://github.com/HoGentTIN/dsai-labs}}\footnote{\url{https://hogenttin.github.io/dsai-glossary/}} while processing your results.

Pay special attention to the following:
\begin{itemize}
	\item Ensure you plan sufficient iterations for each experiment or run.
	\item Only reporting averages is insufficient! At a minimum, include standard deviations and perform statistical tests to verify whether results differ significantly.
	\item Choose appropriate visualizations based on your data (see figure \ref{fig:visuals})
	\item Provide clear titles, axis labels and legends (where needed).
\end{itemize}
...
\begin{figure}
 ...
 \caption[Visualize number data]{\label{fig:visuals}Different ways to visualize the same data.}
\end{figure}
