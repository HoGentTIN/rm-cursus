...
\begin{document}    
    ...
    \begin{frame}{Subject choice}
        ...
        \begin{itemize}
            ...
            \item Relevant conferences/meetups (eg. Devoxx, FOSDEM, Config Management Camp, \ldots)
            \item Local societies (e.g. OWASP Belgium)
            \item Follow the most influential ``community'' names (e.g.\ via blogs or social media)            
            \item Newsletters
            \item Search research databases for recent publications using specific keywords (in a domain of your choosing).
            \item \ldots
        \end{itemize}
    ...
    \end{frame}
      ...
      \begin{frame}
      \frametitle{Group assignment}
      
      \begin{itemize}
          \item Identify and describe 2 concrete research problems
          \begin{itemize}
              \item 1 interdisciplinary 
              \item 1 within chosen specialisation
          \end{itemize}
          \item See practical info slides \& study guide for details
          \item Presentation during EP2
          \begin{itemize}
            \item Includes a written preparation in \LaTeX
        \end{itemize}
        \item 60\% of course grade
      \end{itemize}
  ...
  \end{frame}
      ...
      \begin{frame}
      \frametitle{Group assignment}
              \framesubtitle{Forming groups}
      
      \begin{itemize}
          \item Groups of max. 4 students
          \item Common interest or specialisation?
          \item Register in a Chamilo course group
          \item Deadline: end of week 2.
      \end{itemize}
