...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Is there any prior research available?
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Missing information in bibliography
              ...
              \end{itemize}
        \item Unacceptable sources (\emph{CRAAP!})
        \item Wrong format
        	\begin{itemize}
        		\item Uncleaned URLs
        		\item Google Books URLs or dubious download links
        	\end{itemize}
        \item No references to sources from text
        \item Grouped per type (book, web \ldots)
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Copy from source (citation), translation/paraphrase or images
              \begin{itemize}
                  \item No reference = \alert{plagiarism!}
              \end{itemize}
        \item Refer to results of previous research
        \item For almost every statement on the subject
    \end{itemize}

    \bigskip

    \alertbox{References lend \textcolor{hgyellow}{credibility} to your literature review}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Wikipedia
        \item LLMs with source citations
        	\begin{itemize}
        		\item \url{https://www.perplexity.ai/}
        		\item \url{https://mistral.ai/products/le-chat}
        	\end{itemize}
        ...
        \item HOGENT Catalogue: \url{https://www.hogent.be/student/bibliotheken/}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item<+-> Technical \textbf{portal sites} for ICT related subjects
            \begin{itemize}
                \item vb.~dzone.com, infoq.com, TechNet etc.
            \end{itemize}
    \end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{description}
        ...
        \item[Presentation]<+-> by known expert, e.g.\ at conference (via Youtube, Vimeo $\ldots$)
        \item[Blog article]<+-> if authored by known expert
        \item[Professional journal]<+-> watch out: written by journalist (\textit{not} an expert)
    \end{description}
\end{frame}
...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item Homepage of product or company
              \begin{itemize}
                  \item Can be included text or as a footer
              \end{itemize}
        \item Personal communications
        \item Internal documents (e.g. technical guidelines within a company).
        \item Non-published course material
    \end{itemize}
    \bigskip
      \alertbox{You can only refer to \textcolor{hgyellow}{published content}!}
\end{frame}
...
\begin{frame}
	...
	\begin{itemize}
		\item Superficial sources: ``What is {\ldots}{?}`` and `` \ldots explained in 10 minutes``
		\item Articles about research in mainstream press (find the original publication!)
		\item Lack of diversity (e.g. only online sources/websites)
		\item Illegally published content (f.e. `free` book PDFs) 
		\item Sources residing behind a paywall or requiring a login.
	\end{itemize}
\end{frame}
...
\begin{frame}
    ...
    \begin{description}
        ...
        \item[Relevance] Does this source answer any of your questions? Is it suited for your audience (not too elementary or advanced)?
        \item[Authoritative] Who is the author? A known expert? Any references?
