...
\begin{frame}
  ...
  \begin{itemize}
    \item Easier to search the directory tree
    \begin{itemize}
    ...
    \begin{itemize}
        \item Python/Bash scripts can handle text!
    \end{itemize}
    	\item Future proof!
  \end{itemize}
...
\begin{frame}
  ...
  \begin{itemize}
   ...
   \end{itemize}
  	   \item Finish the preparation and pitch, see:
    
    \url{https://classroom.github.com/a/PX-pNpdE}
  \end{itemize}
\end{frame}
