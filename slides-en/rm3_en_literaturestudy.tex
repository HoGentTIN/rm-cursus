...
\begin{document}
    ...
    \begin{frame}
        ...
        \alertbox{\textcolor{hgyellow}{Every statement} in a literature study needs to be backed up by references}
    \end{frame}
    ...
    \begin{frame}
        ...
        \alertbox{References generate \textcolor{hgyellow}{credibility} to your literature study}
    \end{frame}
