\chapter{Het literatuuroverzicht}%
...
Uit het literatuuroverzicht moet ook naar voor komen dat er nog hiaten in onze kennis zijn, dat er een probleem is dat om een oplossing vraagt. En dat is uiteraard precies het onderwerp van je bachelorproef.
...
\section{Zoekhulpmiddelen en indexen}%
\label{sec:zoekhulpmiddelen-en-indexen}

Om op zoek te gaan naar geschikte bronnen voor je onderzoek, zal je wellicht de neiging hebben om hetzij je favoriete zoekmachine, hetzij je favoriete taalmodel op te starten. Een generische zoekmachine zal echter veel resultaten geven die niet meteen geschikt zijn als bronnen, en taalmodellen kunnen hallucineren en dus foute informatie geven.

In deze sectie bespreken we daarom een aantal zoekhulpmiddelen en indexen die ontworpen zijn om wetenschappelijke en/of vakliteratuur op te zoeken. Meer bepaald zullen we ons daarbij richten op geschikte startpunten voor het zoeken naar ict-gerelateerde vakliteratuur.

\subsection{De HOGENT bib}%
\label{ssec:hogent-bib}

De HOGENT bib heeft als taak om kwalitatieve informatiebronnen beschikbaar te maken voor onderzoekers, docenten en studenten. Dat beperkt zich al lang niet meer tot het ter beschikking stellen van boeken of tijdschriften in druk, maar tegenwoordig vooral elektronische bronnen zoals databanken, e-books, e-journals, enz.

Ga dus zeker naar de website\footnote{\url{https://www.hogent.be/student/bibliotheken/}} kijken of ga persoonlijk langs en vraag de medewerkers om raad.
...
Verder kan je ook zoeken naar vaktijdschrijften of externe databanken voor vakliteratuur. De bib heeft een abonnement op een aantal van deze databanken, en je kan er als student gratis toegang toe krijgen. Je kan een overzicht van deze databanken vinden vanop de website van de bib, onder de rubriek ``Databanken'' en dan doorklikken op ons departement ``IT en Digitale Innovatie'' en ``toegepaste informatica''.

Let er wel op dat deze soms zeer breed zijn, niet echt gericht op ict of minder geschikt als bron voor een bachelorproef (bv.\ LexisNexis, een databank van kranten en nieuwsmagazines). Daarom geven we verderop aan welke dat wel zijn.
...
\begin{itemize}
  \item arXiv\footnote{\url{https://arxiv.org}}: een online archief waar veel auteurs in de exacte wetenschappen hun artikels publiceren voordat ze ze indienen bij een journal, dus vóór het peer-reviewproces. Voor computerwetenschappen vind je er de Computing Research Repository\footnote{\url{http://arxiv.org/corr/home}}.
...
Ook bedrijven hebben soms een technische blog waar ze artikels publiceren over problemen of uitdagingen die ze zijn tegengekomen en hoe ze deze aangepakt hebben. Denk bv.\ aan de google Developers Blog\footnote{\url{https://developers.googleblog.com}}, X Engineering Blog\footnote{\url{https://blog.x.com/engineering/en_us}}, Netflix Tech Blog\footnote{\url{https://netflixtechblog.com}}, AWS Blog\footnote{\url{https://aws.amazon.com/blogs/}}, \dots
...
\section{Onbruikbare bronnen}%
\label{sec:onbruikbare-bronnen}

Wanneer in een tekst verwezen wordt naar de literatuur, dan gaat het telkens over zgn.\ \emph{publicaties}. Een bron moet immers toegankelijk zijn voor de lezer (eventueel mits betaling), m.a.w.\ deze moet \textit{gepubliceerd} zijn.

Naar een Wikipedia-artikel, woordenboeken, zoekresultaat in een index, enz.\ mag je \emph{niet} verwijzen. Een Wikipedia-pagina, bijvoorbeeld, kan immers op elk moment aangepast worden door eender wie, en is dus geen betrouwbare bron. De referentielijst onderaan het Wikipedia-artikel kan wel een goede start zijn voor je zoektocht naar bronnen die wél geschikt zijn.

Andere bronnen die niet thuishoren in een referentielijst zijn:

\begin{itemize}
  \item Andere *pedia-sites zoals Investopedia, Encyclopedia Brittannica, enz.;
  ...
  \item Een intern document van een bedrijf waar je in het kader van je onderzoek mee samenwerkt (bv.\ als opdrachtgever);
  \item Interne communicatie zoals een e-mail die je ontvangen hebt, een chatbericht, een sms-bericht, enz.;
  \item Informele publieke communicatie zoals een tweet, een Facebook-post, enz.;
  \item De (niet gepubliceerde) syllabus of slides van een cursus die je tijdens je opleiding gevolgd hebt;
  \item De homepage van een bedrijf of van een product (hiernaar kan je verwijzen in de tekst of een voetnoot);
  \item Een blogartikel dat niet geschreven is door een vakexpert;
  \item Een bron die door een large language model gegenereerd (of beter: gehallucineerd) is;
  \item Eender welk werk waarvan de auteur of publicatiedatum niet kan achterhaald worden (je kan dan immers de CRAAP-test niet uitvoeren!).
\end{itemize}

De volgende zaken zijn te vermijden:

\begin{itemize}
  \item Googlen naar ``Wat is <vakterm>'' en de eerste de beste zoekresultaten als bron gebruiken. Ga op zoek naar gezaghebbende bronnen uit de vakliteratuur!

  \item Populariserende bronnen gebruiken. Idem, zoek naar vakliteratuur!

  \item Krantenartikels over wetenschappelijk onderzoek aanhalen. Zoek het originele onderzoeksartikel!

  \item Een eenzijdige selectie van bronnen gebruiken, bv.~enkel websites/blogs. Zoek ook andere soorten bronnen op, bv.\ een boek, journalartikel, \ldots

  \item In een bronvermelding een link toevoegen naar Google Books, een illegale downloadsite, \ldots
\end{itemize}
...
\begin{itemize}
  \item Het doel van het literatuuroverzicht is om jezelf en de lezer van je bachelorproef voldoende context te geven om het onderwerp ten gronde te begrijpen. Bespreek relevante thema's voor een lezerspubliek van IT'ers.
  \item Het is belangrijk om bronnen kritisch te beoordelen. Gebruik de CRAAP-test!
  \item Gebruik niet enkel Google  of \'e\'en enkel Large Language Model als startpunt voor je zoektocht, maar gebruik zoekmachines specifiek voor wetenschappelijke en vakliteratuur. Zorg voor variatie in je bronnen! Dus niet enkel blogs of webpagina's, maar zeker ook boeken, technische of wetenschappelijke artikels, enz.
\end{itemize}
